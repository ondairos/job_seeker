  ...
  <li class="mb-7">
    ...
    >
      <div class="pt-5 pb-2 mx-8 border-b border-solid border-brand-gray-2">
        <h2 class="mb-2 text-2xl">Vue Developer</h2>

        <div class="flex flex-row align-middle">
          <div class="mr-5">
            <span>Traverse Group</span>
          </div>
          <div>
            <span>Boston, CA, USA</span>
          </div>
        </div>
      </div>
        ...
        <div>
          ...
          <div>
            <ul class="pl-8 list-disc">
              ...
              <li>Experience creating user interfaces with the Vue framework</li>
            </ul>
          </div>
        </div>
